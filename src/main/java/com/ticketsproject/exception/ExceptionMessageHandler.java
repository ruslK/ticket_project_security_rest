...
import com.ticketsproject.dto.DefaultExceptionMessageDto;
...
public class ExceptionMessageHandler {
    ...
    public ResponseEntity<ResponseWrapper> serviceException(TicketingProjectException se) {
        ...
        return new ResponseEntity<>(
                ResponseWrapper.builder().success(false)
                        .code(HttpStatus.UNAUTHORIZED.value()).message(message).build(),
    ...
    public ResponseEntity<ResponseWrapper> accessDeniedException(AccessDeniedException se) {
        ...
        return new ResponseEntity<>(
                ResponseWrapper.builder().success(false)
                        .code(HttpStatus.FORBIDDEN.value()).message(message).build(),
                HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler({Exception.class, RuntimeException.class, Throwable.class, BadCredentialsException.class, ExpiredJwtException.class})
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.ticketsproject.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.ticketsproject.annotation.DefaultExceptionMessage.class);
